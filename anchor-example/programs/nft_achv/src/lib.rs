...
declare_id!("6HJ2RGDTB88UkzPBgCA8S7MBRjPeNeNsxNpxU1Qeow6t");
...
const ACHIEVEMENTS: [(&str, Achievement, &str, u64); 3] = [
    ("follower_count_1", Achievement::FollowerCount(1), "https://raw.githubusercontent.com/preyanshu/metaplex-core-nft-blink/main/anchor-example/assets/followerfrenzy.json", 1),
    ("streak_days_3", Achievement::StreakDays(3), "https://raw.githubusercontent.com/preyanshu/metaplex-core-nft-blink/main/anchor-example/assets/streakseeker.json", 5),
    ("dscvr_points_1000000000", Achievement::DscvrPoints(1000000000), "https://raw.githubusercontent.com/preyanshu/metaplex-core-nft-blink/main/anchor-example/assets/discoverydynamo.json", 7),
];
    ...
    pub fn create_asset(
        ...
        let achievement = ACHIEVEMENTS.iter().find(|(ach_name, ach_requirement, _, _)| {
            match ach_requirement {
                Achievement::FollowerCount(req) => name == "follower_count_1" && follower_count >= *req,
                Achievement::StreakDays(req) => name == "streak_days_3" && streak_day_count >= *req,
                Achievement::DscvrPoints(req) => name == "dscvr_points_1000000000" && dscvr_points >= *req,
            }
        ...
        // Create the asset without requiring a collection
